...
void R_CMT0_Create(void)
{
    ...
    SYSTEM.MSTPCRA.BIT.MSTPA15 = 0U;

    /* Set control registers */
    CMT0.CMCR.WORD = _0001_CMT_CMCR_CKS_PCLK32 | _0040_CMT_CMCR_CMIE_ENABLE;
    CMT0.CMCOR = _02EE_CMT0_CMCOR_VALUE;
...
void R_CMT1_Create(void)
{
    ...
    /* Set control registers */
    CMT1.CMCR.WORD = _0000_CMT_CMCR_CKS_PCLK8 | _0040_CMT_CMCR_CMIE_ENABLE;
    CMT1.CMCOR = _001E_CMT1_CMCOR_VALUE;
