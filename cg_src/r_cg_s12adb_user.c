...
* Return Value : None
***********************************************************************************************************************/
#pragma vector = VECT_S12AD_S12ADI0
#if FAST_INTERRUPT_VECTOR == VECT_S12AD_S12ADI0
__fast_interrupt static void r_s12ad_interrupt(void)
#else
__interrupt static void r_s12ad_interrupt(void)
#endif
{
