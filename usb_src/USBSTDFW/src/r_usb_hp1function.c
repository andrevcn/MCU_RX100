...
/* functions */
USB_STATIC  void        usb_hstd_bchg_clear_status_p1(void);
USB_STATIC  void        usb_hstd_rwupe_enable_p1(void);
USB_STATIC  void        usb_hstd_rwupe_disable_p1(void);
...
/******************************************************************************
Function Name   : usb_hstd_bchg_clear_status_p1
...
USB_STATIC void usb_hstd_bchg_clear_status_p1(void)
{
    USB_CLR_STS(INTSTS2, USB_BCHG);     /* Status Clear */
}   /* eof usb_hstd_bchg_clear_status_p1() */


/******************************************************************************
Function Name   : usb_hstd_bchg_enable_p1
...
{
    usb_hstd_bchg_clear_status_p1();
    USB_SET_PAT(INTENB2, USB_BCHGE);
}   /* eof usb_hstd_bchg_enable_p1() */


/******************************************************************************
Function Name   : usb_hstd_bchg_disable_p1
...
{
    usb_hstd_bchg_clear_status_p1();
    USB_CLR_PAT(INTENB2, USB_BCHGE);
}   /* eof usb_hstd_bchg_disable_p1() */


/******************************************************************************
Function Name   : usb_hstd_set_uact_p1
...
{
    USB_MDF_PAT(DVSTCTR1, (USB_UACT), (USB_USBRST | USB_RESUME | USB_UACT));
}   /* eof usb_hstd_set_uact_p1() */


/******************************************************************************
Function Name   : usb_hstd_rwupe_enable_p1
Description     : Enable Remote wakeup signal receive
Arguments       : none
Return value    : none
******************************************************************************/
USB_STATIC void usb_hstd_rwupe_enable_p1(void)
...
}   /* eof usb_hstd_rwupe_enable_p1() */


/******************************************************************************
Function Name   : usb_hstd_rwupe_disable_p1
Description     : Disable Remote wakeup signal receive
Arguments       : none
Return value    : none
******************************************************************************/
USB_STATIC void usb_hstd_rwupe_disable_p1(void)
{
    USB_CLR_PAT(DVSTCTR1, USB_RWUPE);
}   /* eof usb_hstd_rwupe_disable_p1() */


/******************************************************************************
Function Name   : usb_hstd_ovrcr_clear_status_p1
...
{
    USB_CLR_STS(INTSTS2, USB_OVRCR);
}   /* eof usb_hstd_ovrcr_clear_status_p1() */


/******************************************************************************
Function Name   : usb_hstd_ovrcr_enable_p1
...
void usb_hstd_ovrcr_enable_p1(void)
{
    ...
    USB_SET_PAT(INTENB2, USB_OVRCRE);
}   /* eof usb_hstd_ovrcr_enable_p1() */


/******************************************************************************
Function Name   : usb_hstd_ovrcr_disable_p1
...
{
    usb_hstd_ovrcr_clear_status_p1();
    USB_CLR_PAT(INTENB2, USB_OVRCRE);
}   /* eof usb_hstd_ovrcr_disable_p1() */


/******************************************************************************
Function Name   : usb_hstd_attch_clear_status_p1
...
{
    USB_CLR_STS(INTSTS2, USB_ATTCH);
}   /* eof usb_hstd_attch_clear_status_p1() */


/******************************************************************************
Function Name   : usb_hstd_attch_enable_p1
...
void usb_hstd_attch_enable_p1(void)
{
    ...
    USB_SET_PAT(INTENB2, USB_ATTCHE);
}   /* eof usb_hstd_attch_enable_p1() */


/******************************************************************************
Function Name   : usb_hstd_attch_disable_p1
...
{
    usb_hstd_attch_clear_status_p1();
    USB_CLR_PAT(INTENB2, USB_ATTCHE);
}   /* eof usb_hstd_attch_disable_p1() */


/******************************************************************************
Function Name   : usb_hstd_detch_clear_status_p1
...
{
    USB_CLR_STS(INTSTS2, USB_DTCH);
}   /* eof usb_hstd_detch_clear_status_p1() */


/******************************************************************************
Function Name   : usb_hstd_detach_enable_p1
...
void usb_hstd_detach_enable_p1(void)
{
    ...
    USB_SET_PAT(INTENB2, USB_DTCHE);
}   /* eof usb_hstd_detach_enable_p1() */


/******************************************************************************
Function Name   : usb_hstd_detach_disable_p1
...
{
    usb_hstd_detch_clear_status_p1();
    USB_CLR_PAT(INTENB2, USB_DTCHE);
}   /* eof usb_hstd_detach_disable_p1() */


/******************************************************************************
Function Name   : usb_hstd_vbus_control_on_p1
...
{
    USB_SET_PAT(DVSTCTR1, USB_VBOUT);
}   /* eof usb_hstd_vbus_control_on_p1() */


/******************************************************************************
Function Name   : usb_hstd_vbus_control_off_p1
Description     : USB VBUS control
Arguments       : none
Return value    : none
******************************************************************************/
...
{
    USB_CLR_PAT(DVSTCTR1, USB_VBOUT);
}   /* eof usb_hstd_vbus_control_off_p1() */


/******************************************************************************
Function Name   : usb_hstd_bus_int_disable_p1
...
}   /* eof usb_hstd_bus_int_disable_p1() */
