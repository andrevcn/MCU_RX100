...
#define _01_SCI_64_128_CLOCK_CYCLES               (0x01U) /* 64 or 128 clock cycles */
#define _10_SCI_186_372_CLOCK_CYCLES              (0x10U) /* 186 or 372 clock cycles */
#define _11_SCI_256_512_CLOCK_CYCLES              (0x11U) /* 256 or 512 clock cycles */
/* Parity mode (PM) */
#define _00_SCI_PARITY_EVEN                       (0x00U) /* Parity even */
#define _10_SCI_PARITY_ODD                        (0x10U) /* Parity odd */
/* Parity enable (PE) */
...
#define _00_SCI_BLK_TRANSFER_DISABLE              (0x00U) /* Data length 8 bits */
#define _40_SCI_BLK_TRANSFER_ENABLE               (0x40U) /* Data length 7 bits */
/* GSM mode (GSM) */
#define _00_SCI_GSM_DISABLE                       (0x00U) /* Asynchronous mode */
#define _80_SCI_GSM_ENABLE                        (0x80U) /* Clock synchronous mode */
...
#define _08_SCI_MP_INTERRUPT_SPECIAL              (0x08U) /* Special reception */
/* Receive enable (RE) */
...
#define _00_SCI_TXI_ERI_DISABLE                   (0x00U) /* Disable TXI interrupt requests */
#define _80_SCI_TXI_ERI_ENABLE                    (0x80U) /* Enable TXI interrupt requests */

/*
    Serial status register (SSR)
*/
/* Parity error flag (PER) */
#define _04_SCI_PARITY_ERROR                      (0x04U) /* A parity error has occurred */
...
#define _00_SCI_SSCL_CLOCK_OUTPUT                 (0x00U) /* SSDA output is serial data output */
#define _40_SCI_SSCL_START_RESTART_STOP_CONDITION (0x40U) /* SSDA output generates start, restart or stop condition */
#define _80_SCI_SSCL_LOW_LEVEL                    (0x80U) /* SSDA output low level */
#define _C0_SCI_SSCL_HIGH_IMPEDANCE               (0xC0U) /* SSDA output high impedance */
...
#define _01_SCI_CTS                               (0x01U) /* CTS function is disabled */
...
/* Functions from r_cg_sci_user.h */
...
/* The id received from the master in the LIN receive interrupt handler */
extern volatile uint8_t g_id;

/* Flag set in the LIN receive interrupt handler to show id has been received*/
extern volatile uint8_t g_id_received;

/* Flag to indicate when ADC data has been received from the slave */
extern volatile uint8_t g_tx12_done;
