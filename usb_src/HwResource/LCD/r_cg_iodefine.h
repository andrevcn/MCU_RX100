...
/* History    : V0.9A  (2013-05-14)  [Hardware Manual Revision : 0.90]          */
...
/* File Name  : iodefine.h                                                      */
/* Abstract   : Definition of I/O Register.                                     */
/* History    : V0.5A  (2013-02-12)  [Hardware Manual Revision : 0.50 + Adds]   */
/* Note       : This is a typical example.                                      */
/*                                                                              */
/*  Copyright(c) 2013 Renesas Electronics Corp.                                 */
/*                  And Renesas Solutions Corp. ,All Rights Reserved.           */
...
#define PORTH   (*(volatile struct st_porth  __sfr __evenaccess *)0x8C051)
