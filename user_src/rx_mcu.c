...
#include "iorx111.h"                   /* MCU IO definition */
...
******************************************************************************/
#pragma bitfields=reversed/* Structure that uses reversed bitfields. */
...
/*=== Interrupt =============================================================*/
__interrupt void        usb_cpu_usb_interrupt(void);
__interrupt void        usb_cpu_usb_resume_interrupt(void);
__interrupt void        usb_cpu_irq0_interrupt(void);
__interrupt void        usb_cpu_d0fifo_interrupt(void);
...
void usb_cpu_target_init(void)
{
    usb_cpu_set_pin_function();//NÃO É AQUI         /* Interim procedures */

    usb_cpu_usbint_init(); //NÃO É AQUI TAMBÉM             /* Initialized USB interrupt */
    usb_cpu_DmaintInit();
